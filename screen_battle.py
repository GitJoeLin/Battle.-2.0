...
class Screen_Battle (tkinter.Frame):
    ...
    def create_widgets (self):
        ...
        self.atk2 = tkinter.Button(self, text = self.player1.attack2, command=self.attack2_clicked)
        self.atk2.grid(row = 8, column = 0)
        self.atk3 = tkinter.Button(self, text=self.player1.attack3, command = self.attack3_clicked)
        self.atk3.grid(row = 9, column = 0)
    ...
    def attack1_clicked(self):
        ...
        if self.player1.name == "Elf":
            if ability_chance == 1:
                ...
                a1 = self.player1.back_stab(self.player2) + ". Elf's dexterity was raised by " + str(num) + "because of his Super Speed ability!"
    ...
    def attack3_clicked(self):
        ...
        if self.player1.name == "Orc":
            if ability_chance == 1:
                ...
                num = random.randint(5, 15)
                self.player1.strength += num
                a1 = "Orc fell asleep for one turn because of his exhaustion, but his attack was raised by " + str(
                    num) + "!"
